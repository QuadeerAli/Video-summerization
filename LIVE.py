...
def LiveRecognition(query):
    ...
    #Create video result
    writer = cv2.VideoWriter(r'C:\Users\kruthika\OneDrive\Documents\Final_video_summarization\video_summarization\static\outputvideo\1.mp4',cv2.VideoWriter_fourcc(*'H264'), 25, (width, height))
    ret, frame1 = vs.read()
    prev_frame = frame1
